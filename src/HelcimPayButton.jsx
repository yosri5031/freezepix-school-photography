...
const HelcimPayButton = ({ 
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const timeoutDuration = 2200; // Set the timeout duration to 5 seconds for both PC and mobile
      ...
      const appendDelay = isMobile ? 2200 : 2200;
      ...
      setTimeout(() => {
        if (window.appendHelcimPayIframe) {
          ...
          setTimeout(() => {
            setLoading(false);
          }, 2200); // Adjust the duration to 5000 milliseconds (5 seconds)
        } else {
